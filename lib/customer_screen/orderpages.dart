              ...
              children: [
                Container(
                  ...
                  padding: EdgeInsets.only(
                      top: size.height * 0.08, left: 15, right: 15),
                                ...
                                void addToCart() async {
                                  if (widget.cartList.contains(widget.itemID)) {
                                    ...
                                    await FirebaseFirestore.instance
                                        .collection("users")
                                        .doc(App.sharedPreferences
                                            .getString("email"))
                                        .update({"cart": widget.cartList}).then(
                                            (value) {
  ...
  void buyNow() async {
    ...
    if (flag == 1) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => DeliveryPage(widget.imageUrl, widget.title,
                  widget.price, widget.desc, widget.itemID, widget.seller)));
    } else {
